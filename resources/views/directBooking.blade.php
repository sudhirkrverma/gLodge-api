                    ...
                    <form action="/bookingConfirmation" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="age" name="age" placeholder="Enter youe age"
                                    value="{{old('age')}}">
                                @error('age')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                        ...
                        <input type="hidden" name="amount" value="{{$room->price  * $interval}} " readonly>


                        <input type="submit" class="btn btn-success font-weight-bold mb-2"
                            style="width: 100%; font-size: 16px;" value="Continue to Book">
        ...
        <div class="col-md-4 secondhalf" style="box-shadow: #b38d8d 5px 5px 4px 4px">
            <div id="greeting">
                <h5 class="text-center font-weight-bold mt-2"
                    ...
                    {{$room->room_no}}- {{$room->room_type}}, {{$room->lodge_name}}
                </h5>
            ...
            <div id="customerDetails">
                ...
                <form action="/directBooking" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="from" name="checkin" aria-describedby="emailHelp"
                            value="{{$data['checkin']}}  ({{$checkinDay}})" placeholder="From" readonly>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">To :</label>
                        <input type="text" class="form-control" id="to" name="checkout"
                            value="{{$data['checkout']}} ({{$checkoutDay}})" placeholder="To" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <h5 class="font-weight-bold" style="text-align: end;">&#8377; {{$room->price * $interval}}
                            </h5>
                        </div>
                        <div class="form-group col-md-12 mb-0">

                            <h5 class="text-dark text-center" style="background-color: blanchedalmond; padding: 14px;">
                                You can pay at desk.!</h5>
                        </div>
                    </div>
